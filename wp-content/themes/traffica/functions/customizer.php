...
class Traffica_Customizer {
    ...
    public static function Traffica_Sections($wp_customize) {
        ...
        $wp_customize->add_section('social_network_section', array(
            'title' => __('Social Site links', 'traffica'),
            'description' => __('Allows you to setup social Site links for Traffica Theme.', 'traffica'),
            'priority' => '13',
            'panel' => ''
        ));
    ...
    public static function Traffica_Settings() {
        $traffica_settings = array(
            ...
            'inkthemes_facebook' => array(
                'id' => 'traffica_options[inkthemes_facebook]',
            ...
            'inkthemes_twitter' => array(
                'id' => 'traffica_options[inkthemes_twitter]',
            ...
            'inkthemes_google' => array(
                'id' => 'traffica_options[inkthemes_google]',
            ...
            'inkthemes_rss' => array(
                'id' => 'traffica_options[inkthemes_rss]',
            ...
            'inkthemes_pinterest' => array(
                'id' => 'traffica_options[inkthemes_pinterest]',
            ...
            'inkthemes_linked' => array(
                'id' => 'traffica_options[inkthemes_linked]',
            ...
            'inkthemes_instagram' => array(
                'id' => 'traffica_options[inkthemes_instagram]',
            ...
            'inkthemes_youtube' => array(
                'id' => 'traffica_options[inkthemes_youtube]',
            ...
            'inkthemes_tumblr' => array(
                'id' => 'traffica_options[inkthemes_tumblr]',
            ...
            'inkthemes_flickr' => array(
                'id' => 'traffica_options[inkthemes_flickr]',
